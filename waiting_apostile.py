...
# ==============================
load_dotenv()
OUTPUT_FILE = "waiting_apostille_data.csv"
LOGIN_URL = "https://apostille.mygov.bd/login"
BASE_DASHBOARD_URL = "https://apostille.mygov.bd/front-desk/dashboard?applicationStatus=waiting&page="
...
async def scrape_application(page, application_id):
    ...
    try:
        ...
        return {"application_id": application_id, "Status": "অপেক্ষমান", "error": str(e)}
