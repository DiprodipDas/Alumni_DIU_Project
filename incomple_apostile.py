...
# CONFIG
# ==============================
OUTPUT_FILE = "incomplete_apostille_data.csv"

load_dotenv()
LOGIN_URL = "https://apostille.mygov.bd/login"
BASE_DASHBOARD_URL = "https://apostille.mygov.bd/front-desk/dashboard?applicationStatus=rejected&page="
...
async def scrape_application(page, application_id):
    url = f"{BASE_APPLICATION_URL}{application_id}?applicationStatus=rejected&page=1"
    try:
        ...
        return {"application_id": application_id, "Status": "অসম্পূর্ণ", "error": str(e)}
