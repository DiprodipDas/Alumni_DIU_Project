...
# ==============================
load_dotenv()
OUTPUT_FILE = "forwarded_apostille_data.csv"
LOGIN_URL = "https://apostille.mygov.bd/login"
BASE_DASHBOARD_URL = "https://apostille.mygov.bd/front-desk/dashboard?applicationStatus=forwarded&page="
...
async def scrape_application(page, application_id):
    ...
    try:
        ...
        return {"application_id": application_id, "Status": "প্রেরিত", "error": str(e)}
